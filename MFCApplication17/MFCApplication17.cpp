...
BEGIN_MESSAGE_MAP(CMFCApplication17App, CWinAppEx)
...
CMFCApplication17App::CMFCApplication17App() noexcept
{
...
BOOL CMFCApplication17App::InitInstance()
{
	...
	pDocTemplate = new CMultiDocTemplate(IDR_MFCApplication17TYPE,
...
// CMFCApplication17App customization load/save methods

void CMFCApplication17App::PreLoadState()
{
	BOOL bNameValid;
	CString strName;
...
void CMFCApplication17App::LoadCustomState()
{
}

void CMFCApplication17App::SaveCustomState()
{
}
